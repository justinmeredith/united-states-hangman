...
string selectRandomState(const vector<string>& usa_array) {
    static mt19937 random_number_generator(random_device{}());
    uniform_int_distribution<int> range(0, usa_array.size() - 1);
    return usa_array.at(range(random_number_generator));
};
